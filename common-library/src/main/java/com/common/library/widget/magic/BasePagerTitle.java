...
public class BasePagerTitle extends CommonPagerTitleView {
    ...
    int selectTextColor = getResources().getColor(R.color.colorPrimary);
    int unSelectTextColor = getResources().getColor(R.color.color_666);

    public BasePagerTitle(Context context, @NonNull String title) {
        this(context, title, 0);
    }

    public BasePagerTitle(Context context, @NonNull String title, int icon) {
        super(context);

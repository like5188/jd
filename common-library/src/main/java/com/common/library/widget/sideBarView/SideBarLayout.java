...
public class SideBarLayout extends RelativeLayout implements SideBarSortView.OnIndexChangedListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            if(wordBackground==null){
                wordBackground= context.getResources().getDrawable(R.drawable.base_sort_text_view_hint_bg);
            }
            ta.recycle();
        }
    }
    private void initView() {
        //引入布局
        mLayout = LayoutInflater.from(mContext).inflate(R.layout.base_view_sidebar_layout, null,true);

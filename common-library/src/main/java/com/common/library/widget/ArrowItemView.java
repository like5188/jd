...
public class ArrowItemView extends ConstraintLayout {
    ...
    public void setAvatarSrcResId(int avatarSrcResId) {
        this.avatarSrcResId = avatarSrcResId;
        avatar.setImageResource(avatarSrcResId);
    }
    ...
    public void init(Context context, AttributeSet attrs) {
        root = LayoutInflater.from(context).inflate(R.layout.base_layout_item_arrow, this);
        ...
        titleColor = a.getColor(R.styleable.ArrowItemView_arrowItemTitleColor, ContextCompat.getColor(getContext(), R.color.color_132));
        if(titleColorId != -1) {
        ...
        contentColor = a.getColor(R.styleable.ArrowItemView_arrowItemContentColor, ContextCompat.getColor(getContext(), R.color.color_999));
        if(contentColorId != -1) {
    ...
    public CustomImageView getAvatar() { return avatar; }

...
public class CustomImageView extends AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            borderColor = array.getColor(R.styleable.CustomImageView_ease_border_color, borderColor);
            borderWidth = array.getDimensionPixelOffset(R.styleable.CustomImageView_ease_border_width, borderWidth);
            pressAlpha = array.getInteger(R.styleable.CustomImageView_ease_press_alpha, pressAlpha);
            pressColor = array.getColor(R.styleable.CustomImageView_ease_press_color, pressColor);
            radius = array.getDimensionPixelOffset(R.styleable.CustomImageView_ease_radius, radius);
            shapeType = array.getInteger(R.styleable.CustomImageView_ease_shape_type, shapeType);
            array.recycle();
        }

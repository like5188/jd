...
public final class SimpleRatingBar extends View {
    ...
    public SimpleRatingBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mNormalDrawable = ContextCompat.getDrawable(getContext(), array.getResourceId(R.styleable.SimpleRatingBar_normalDrawable, R.drawable.base_rating_star_off_ic));
        mHalfDrawable = ContextCompat.getDrawable(getContext(), array.getResourceId(R.styleable.SimpleRatingBar_halfDrawable, R.drawable.base_rating_star_half_ic));
        mFillDrawable = ContextCompat.getDrawable(getContext(), array.getResourceId(R.styleable.SimpleRatingBar_fillDrawable, R.drawable.base_rating_star_fill_ic));
        // 两张图片的宽高不一致
        ...
        isEdit = array.getBoolean(R.styleable.SimpleRatingBar_isEdit, true);

...
/**
 * Created by *** on 2022/1/13 5:01 下午
 * Supporte By 宇宙无敌大公司.
 ...
 * @author 又是谁写的
 */
abstract class BasePagingDataAdapter<T : Any, VH : BaseViewHolder> constructor(
    diffCallback: DiffUtil.ItemCallback<T>,
    val layOutId: Int,
) : PagingDataAdapter<T, VH>(diffCallback) {


    var mItemClickListener: ((v: View, position: Int) -> Unit)? = null
    var mItemLongClickListener: ((v: View, position: Int) -> Boolean)? = null
    var mItemChildClickListener: ((v: View, position: Int) -> Unit)? = null

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VH {
        val inflate = LayoutInflater.from(parent.context).inflate(layOutId, parent, false)
        val viewHolder = createBaseViewHolder(inflate)

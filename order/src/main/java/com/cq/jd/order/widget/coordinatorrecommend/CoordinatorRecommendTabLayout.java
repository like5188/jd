package com.cq.jd.order.widget.coordinatorrecommend;
...
public class CoordinatorRecommendTabLayout extends CoordinatorLayout {
    ...
    public CoordinatorRecommendTabLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        if (!isInEditMode()) {
            initView(context);
    ...
    public CoordinatorRecommendTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context) {
        LayoutInflater.from(context).inflate(R.layout.view_coordinatorrecommendtablayout, this, true);
        initToolbar();
     ...
     */
    public CoordinatorRecommendTabLayout setTitle(String title) {
        if (mActionbar != null) {
     ...
     * @return CoordinatorRecommendTabLayout
     */
    public CoordinatorRecommendTabLayout setBackEnable(Boolean canBack) {
     ...
     * @return CoordinatorRecommendTabLayout
     */
    public CoordinatorRecommendTabLayout setImageArray(@NonNull int[] imageArray) {
     ...
     * @return CoordinatorRecommendTabLayout
     */
    public CoordinatorRecommendTabLayout setImageArray(@NonNull int[] imageArray, @NonNull int[] colorArray) {
        mImageArray = imageArray;
     ...
     * @return CoordinatorRecommendTabLayout
     */
    public CoordinatorRecommendTabLayout setContentScrimColorArray(@NonNull int[] colorArray) {
        mColorArray = colorArray;
        return this;
    }
     ...
     * @return CoordinatorRecommendTabLayout
     */
    public CoordinatorRecommendTabLayout setTabMode(@TabLayout.Mode int mode) {
     ...
     * @return CoordinatorRecommendTabLayout
     */
    public CoordinatorRecommendTabLayout setupWithViewPager(ViewPager viewPager) {
        setupTabLayout();
     ...
     * @return CoordinatorRecommendTabLayout
     */
    public CoordinatorRecommendTabLayout setLoadHeaderImagesListener(LoadHeaderImagesListener loadHeaderImagesListener) {
     ...
     * @return CoordinatorRecommendTabLayout
     */
    public CoordinatorRecommendTabLayout addOnTabSelectedListener(OnTabSelectedListener onTabSelectedListener) {
     ...
     * @return CoordinatorRecommendTabLayout
     */
    public CoordinatorRecommendTabLayout setTranslucentStatusBar(@NonNull Activity activity) {
     ...
     * @return CoordinatorRecommendTabLayout
     */
    public CoordinatorRecommendTabLayout setTranslucentNavigationBar(@NonNull Activity activity) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return this;
        } else {

...
import com.cq.jd.order.widget.mzbanner.transformer.CoverModeTransformer;
import com.cq.jd.order.widget.mzbanner.transformer.ScaleYTransformer;
...
public class MZBannerView<T> extends RelativeLayout {
    ...
    private final int []mIndicatorRes= new int[]{R.drawable.indicator_normal, R.drawable.indicator_selected};
    ...
    private void init(){
      ...
      mViewPager = (CustomViewPager1) view.findViewById(R.id.mzbanner_vp);
